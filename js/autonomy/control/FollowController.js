...
export default class FollowController {
	...
	**/
	findNextIndex ( pos ) {
		...
		// Constrain the search to just a few points surrounding the current
		// nextIndex for performance and to avoid problems with
		...
		if ( closestIndex == pathPoses.length - 1 ) {
			...
			// Project the pos to both of those two line segments (the segment
			// preceding closestPoint and the segment succeeding closestPoint)
