/**
** Consider to use side lib for mapping.
** @see https://github.com/sermonis/vue-three-mapgl
** @see https://github.com/sermonis/three-geo-three
** @see https://github.com/sermonis/three-digital-twin
** @see https://github.com/sermonis/three-procedural-gl-js
**/
export default class MapObject extends THREE.Object3D {
	...
	**/
	...
	/**
	** Converts lat-long geolocation
	** to Google Maps world coodinates.
	**/
	...
	/**
	** Calculates the x and y tile indices
	** for the provided world coordinates.
	**/
	static worldToTile ( worldCoordinates ) {

		return [

			Math.floor( worldCoordinates[ 0 ] * MapObject.SCALE / 256 ),
			Math.floor( worldCoordinates[ 1 ] * MapObject.SCALE / 256 )
	...
	**/
	tileSizeInMeters () {
		...
		// Because of the Mercator projection used to create the tile images,
		// the size of a tile (in meters) depends on the latitude.
