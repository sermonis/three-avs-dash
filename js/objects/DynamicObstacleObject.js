export default class DynamicObstacleObject extends THREE.Object3D {
	...
	constructor ( dynamicObstacle, lanePath ) {
		...
		const geometry2D = new THREE.PlaneGeometry( dynamicObstacle.size.w * 2, dynamicObstacle.size.h * 2 );
		...
		const geometry3D = new THREE.BoxBufferGeometry( dynamicObstacle.size.w * 2, heights[ dynamicObstacle.type ] || 1.5, dynamicObstacle.size.h * 2 );
